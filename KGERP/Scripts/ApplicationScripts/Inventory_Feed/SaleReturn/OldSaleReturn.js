...
function createRowForStock() {
    ...
    if (isAllValid) {
        ...
        var indexCell = "<td style='display:none'> <input type='hidden' id='Index " + index + "' name='SaleReturnDetails.Index' value='" + index + "' /> </td>";
        var serialCell = "<td>" + ++sl + "</td>";
        var productNameCell = "<td><input type='hidden' id='ProductId" + index + "' name='SaleReturnDetails[" + index + "].ProductId' value='" + selectedItems.ProductId + "' />" + selectedItems.ProductName + " </td>";
        var qtyCell = "<td><input type='hidden' class='quantityCell' id='Qty" + index + "' name='SaleReturnDetails[" + index + "].Qty' value='" + selectedItems.Qty + "' />" + selectedItems.Qty + " </td>";
        var rateCell = "<td><input type='hidden' id='Rate" + index + "' name='SaleReturnDetails[" + index + "].Rate' value='" + selectedItems.Rate + "' />" + selectedItems.Rate + " </td>";
        var amountCell = "<td><input class='totalPrice' type='hidden' id='Amount" + index + "' name='SaleReturnDetails[" + index + "].Amount' value='" + selectedItems.Amount + "' />" + selectedItems.Amount + " </td>";
        var removeCell = "<td><input type='button' id='removeItem' class='remove btn btn-danger btn-xs' value='Remove'/> </td>";
        var createNewRow = "<tr id='" + (++sl) + "'>" + indexCell + serialCell + productNameCell + qtyCell + rateCell + amountCell + removeCell + " </tr>";
